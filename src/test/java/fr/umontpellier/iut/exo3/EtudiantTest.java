...
class EtudiantTest {
    ...
    public void test_classe_Etudiant_remplacer() {
        ...
        lolo.remplacer(jojo);
        assertEquals(lolo.toString(), "L'étudiant Pytes Robert (robert.pytes@etu.umontpellier.fr) né(e) le 08/08/2004 a comme adresse postale '45 Avenue Carnot, 30100 Alès', avec 0 enregistrée(s) et une moyenne de 0.0.");
